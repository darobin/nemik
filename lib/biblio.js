...
function lookup (k) {
  return ({
    ...
    'consenter': {
      title: 'Consenter',
      href: 'https://www.consenter.eu/',
      authors: ['Max von Grafenstein'],
    },
    'cnil-exemptions': {
      ...
      href: 'https://www.cnil.fr/sites/default/files/atoms/files/lignes_directrices_de_la_cnil_sur_les_cookies_et_autres_traceurs.pdf',
      authors: ['CNIL'],
      date: '2020-09-17',
    },
    'fiduciary-ua': {
    ...
    'wikipedia-ads': {
      ...
      href: 'https://www.techpolicy.press/how-wikipedia-can-save-the-internet-with-advertising/',
      authors: ['Robin Berjon'],
      date: '2025-09-22',
    },
